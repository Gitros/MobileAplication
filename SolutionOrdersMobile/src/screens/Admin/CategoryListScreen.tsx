...
type Props = NativeStackScreenProps<AdminStackParamList, 'CategoryList'>;
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        ListEmptyComponent={<EmptyView message="No categories yet" />}
        renderItem={({ item }) => (
          <View style={styles.row}>
            ...
            <View style={styles.actions}>
              <TouchableOpacity onPress={() => navigation.navigate('CategoryForm', { id: item.id })}>
